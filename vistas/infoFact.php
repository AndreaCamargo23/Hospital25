...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">	
								<form id="info_facturas">
									<div class="flex-row d-flex justify-content-">
										<div class="col-lg-7 col-11 px-1">
											<div class="input-group input-daterange"> 
												<label class="ml-3 form-control-placeholder" for="start">Start Date  </label>
												<input type="date" id="start" class="form-control text-left ml-2" required>	
												<label class="ml-3 form-control-placeholder" for="end" required>End Date </span></label> 
										...
										<div class="col-lg-2">
										  <div class="form-group">
											  <select class="form-select" id="tipo" aria-label="Default select example">
												<option selected value="3">Seleccione una opción</option>
												<option value="15">Generada</option>
												<option value="13">Pagada</option>
											  </select>
										  </div> 									
										</div>
										<button type="submit" id="btnAgregar" class="btn btn-primary" data-toggle="modalServicio" style="height:43px;">
				...
				<div class="card shadow mb-8">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                   <table id="tablaInformes" class="table table-bordered">
	...
	<script src="./js/data-infoFact.js"></script> 
    <!--Notificaciones-->
